...
%%% Beginning of the time integration section%%%%%%%%%
	...
	\subsection*{Newmark--Beta Implicit Time Integration}
	...
	\begin{equation}
		\mathit{\mathbf{C}} = \alpha_R \mathit{\mathbf{M}} + \beta_R \mathit{\mathbf{K}},
	\end{equation}
	where \( \alpha_R \) and \( \beta_R \) are mass- and stiffness-proportional damping coefficients.
